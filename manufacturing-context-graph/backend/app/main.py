...
from app.manufacturing_reasoning import load_manufacturing_reasoning
...
async def lifespan(app: FastAPI):
    ...
    try:
        load_manufacturing_reasoning()
    except Exception as e:
        logger.warning("Manufacturing reasoning package unavailable: %s", e)
